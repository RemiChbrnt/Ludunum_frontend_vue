<template>
  <div>
    <div style="margin: 2%; padding: 2%; width: 60%; height: 620px; background-color: #faebd780;">
      ...
      <p style= "align-self: center; float: right; text-align: justify; font-size: 140%; padding-left: 5%; padding-right: 5%;">
        Zoé Battello,
        <br>&emsp;&emsp;Rémi Chabrant,
        <br>&emsp;&emsp;&emsp;&emsp;Hugo Desinde,
        <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Safae Hariri,
        <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Violette Marcinkowski,
        <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;David Rodhain,
        <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Derhen Rufflé
      </p>
    </div>
    <div class="mascotte">
      <h1> BIENVENUE !</h1>
